...
insert into app.tb_roles(role_id,nome) values(1,'ADMIN');
insert into app.tb_roles(role_id,nome) values(1,'SUPERVISOR');
insert into app.tb_roles(role_id,nome) values(1,'AUXILIAR');

insert into app.tb_roles_usuarios(role_id,usuario_id) values(1,1);
